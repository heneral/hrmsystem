<x-app-layout>
    <x-slot name="header">
        <div class="flex items-end justify-between">
            ...
            <a
                href="{{ route('admin.reports.reservations.csv') }}"
    ...
    <div class="min-h-screen bg-stone-50 py-8">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ([['label' => 'Total reservations', 'value' => $summary['total']], ['label' => 'Confirmed', 'value' => $summary['confirmed']], ['label' => 'Checked in', 'value' => $summary['checked_in']], ['label' => 'Booked revenue', 'value' => '$'.number_format($summary['revenue'], 2)]] as $metric)
                    <div
            ...
            >
                <div>
                    <h3 class="text-xl font-semibold">Filter reservations</h3>
                    <p class="mt-1 text-sm text-stone-500">Narrow the report by stay window and lifecycle status.</p>
                </div>
            ...
            >
                <div class="border-b border-stone-200 p-6">
                    <h3 class="text-xl font-semibold">Reservation activity</h3>
                    <p class="mt-1 text-sm text-stone-500">{{ $reservations->total() }} matching reservations</p>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        <thead>
                            ...
                            >
                                <th class="px-6 py-4">Confirmation</th>
                            ...
                            @forelse ($reservations as $reservation)
                                ...
                                >
                                    <td class="px-6 py-4">
                                        ...
                                        <p class="mt-1 text-xs text-stone-500">{{ $reservation->room->roomType->name }}</p>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="rounded-full bg-stone-100 px-3 py-1 text-xs font-semibold capitalize"
